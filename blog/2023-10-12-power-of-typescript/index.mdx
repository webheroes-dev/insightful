...
- using TypeScript itselt introduces some degree of safety to our codebase
...
```
If a property is absent in any of the members, it is removed when we're using union.
